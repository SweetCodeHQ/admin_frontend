    ...
    <>
      <div className="flex flex-col h-full">
        <div className="flex flex-col items-center mb-5">
          ...
          <p className="text-left mt-5 text-white font-light text-center text-2xl">
        ...
        <div className="bg-gradient-to-b from-[#3A1F5C] via-[#006c67] to-[#ffc857]">
          <div className="text-white p-10 ml-10 mr-10 text-lg">
            <p>
              ...
              's years of experience in technical content marketing has taught
              us that the topic curation process is a high hurdle that often
              derails content strategy. Figuring out what your target audience
              wants to read can be the most challenging part of the content
              creation process.
            </p>
            <br />
            <p>
              ...
              conjunction with Fixate’s Virtual Domain Experts models, Curio
              helps companies curate content topics faster, so they can
              accelerate the content creation and publishing process.
            </p>
          </div>
          <div className="text-white text-lg flex place-items-center">
            <div className="font-semibold ml-10 mr-10 ml-10 p-10">
              ...
              <p>
                ...
                Curio’s feature to export to Google Docs and write the content
                on your own.
              </p>
            </div>
          </div>
          <div className="text-white flex place-items-center">
            <div className="pl-10 pr-10 text-lg font-semibold ml-10 mr-10">
              ...
              <p>
                ...
                identify the best content topics, break through writer’s block
                and produce content that will have the highest impact on your
                target audiences.
              </p>
            </div>
          </div>
          <div className="text-white">
            <div className="pb-10 pt-20 pt-10 pl-20 pr-20 text-lg font-semibold">
